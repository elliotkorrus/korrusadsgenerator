...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: "var(--surface-0)", color: "var(--text-primary)" }}>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="leading-none">
              <h1
                ...
                style={{ fontFamily: "'IBM Plex Sans', sans-serif", letterSpacing: "-0.01em" }}
              >
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `flex items-center gap-2.5 px-2.5 py-[7px] text-[11px] font-medium transition-all duration-100 rounded-sm ${
                  isActive
                    ? "border-l-2 border-[#0099C6] pl-[9px]"
              ...
              {({ isActive }) => (
                <>
                  <item.icon
                    ...
                    style={{ color: isActive ? "#0099C6" : undefined }}
                  />
                  {item.label}
                </>
              )}
        ...
        <div className="px-4 py-3" style={{ borderTop: "1px solid var(--surface-3)" }}>
          <div className="flex items-center gap-1.5">
            <span
              ...
              style={{ background: "#3fb950", boxShadow: "0 0 4px #3fb950aa" }}
            />
      ...
      {/* Main — full overflow so table can scroll horizontally */}
